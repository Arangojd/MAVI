...
enum MaviDigitalPin : int
{
	...
	MAVI_DPIN_USLL_TRIG = 20,
	MAVI_DPIN_USLL_ECHO = 16,
	MAVI_DPIN_USLR_TRIG = 21,
	MAVI_DPIN_USLR_ECHO = 12,
	MAVI_DPIN_USUL_TRIG = 18,
	MAVI_DPIN_USUL_ECHO = 14,
	MAVI_DPIN_USUR_TRIG = 24,
	MAVI_DPIN_USUR_ECHO = 15,
